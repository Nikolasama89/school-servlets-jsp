...
public class StudentDAOImpl implements IStudentDAO{
    ...
    public Student insert(Student student) throws StudentDAOException {
        String sql = "INSERT into students ( firstname, lastname, vat, fathername, phone_num, email, street," +
        ...
        try (Connection connection = DBUtil.getConnection();
             // Με το Statement.RETURN_GENERATED_KEYS θα παρουμε το ID που εχει δημιουργηθει απο την ΒΔ.
            ...
            e.printStackTrace();
            throw new StudentDAOException("SQL Error in insert student with VAT: " + student.getVat());
        }
    ...
    public Student update(Student student) throws StudentDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            ps.setString(9, student.getZipCode());
            ps.setInt(10, student.getCityId());
//            ps.setTimestamp(11, Timestamp.valueOf(teacher.getUpdatedAt())); ΕΙΝΑΙ ΤΟ ΙΔΙΟ ΜΕ ΤΟ ΑΠΟ ΚΑΤΩ
